...
public class InventoryTableRenderer<V> implements TableRenderer<V> {
    ...
    private boolean hideLastColumn;
    ...
    public void hideLastColumn(boolean hide) {
    	this.hideLastColumn = hide;
    }
    
    private int hiddenColumns() {
    	return hideLastColumn ? 1 : 0;
    }
    ...
    public TerminalSize getPreferredSize(Table<V> table) {
        ...
        if(visibleColumns == 0) {
            visibleColumns = tableModel.getColumnCount() - hiddenColumns();
        }
        if(visibleRows == 0) {
    ...
    private int drawHeader(TextGUIGraphics graphics, Table<V> table) {
        ...
        int visibleColumns = table.getVisibleColumns();
        if(visibleColumns == 0) {
            visibleColumns = table.getTableModel().getColumnCount() - hiddenColumns();
        }
        int topPosition = 0;
        int leftPosition = 0;
    ...
    private void drawRows(TextGUIGraphics graphics, Table<V> table, int topPosition) {
        ...
        if(visibleColumns < tableModel.getColumnCount() - hiddenColumns()) {
